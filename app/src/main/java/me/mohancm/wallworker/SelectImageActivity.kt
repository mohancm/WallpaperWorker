...
import me.mohancm.wallworker.databinding.ActivitySelectImageBinding
import java.util.*
...
class SelectImageActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            Log.e(TAG, "Unexpected Result code %s".format(resultCode))
        }
    }
    ...
    private fun handleImageRequestResult(intent: Intent) {
        ...
        val filterIntent = Intent(this, WallpaperActivity::class.java)
